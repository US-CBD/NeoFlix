...
class SettingsFrame:
    def __init__(self, settings, settings_frame):
        ...
        self.favourites = self.settings.user.get_favourite_films()
    ...
    def configure_genres(self):
        ...
        for i, genre in enumerate(self.genres):
            var = tk.IntVar(value=1 if genre in self.settings.selected_genres else 0)
    ...
    def configure_favourites(self):
        self.scrollable_films_frame = ScrollableFilmsFrames(self.favorites_frame, self.favourites, self.settings)
    ...
    def configure_load_button(self):
        ...
        load_button.bind("<Button-1>", self.load_db)
